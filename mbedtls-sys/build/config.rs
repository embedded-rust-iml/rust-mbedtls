...
const DEFAULT_DEFINES: &'static [CDefine] = &[
    ...
    ("MBEDTLS_CIPHER_MODE_CBC",                           Undefined),
    ("MBEDTLS_CIPHER_MODE_CFB",                           Undefined),
    ("MBEDTLS_CIPHER_MODE_CTR",                           Undefined),
    ("MBEDTLS_CIPHER_MODE_OFB",                           Undefined),
    ("MBEDTLS_CIPHER_MODE_XTS",                           Undefined),
    ("MBEDTLS_CIPHER_NULL_CIPHER",                        Undefined),
    ("MBEDTLS_CIPHER_PADDING_PKCS7",                      Undefined),
    ("MBEDTLS_CIPHER_PADDING_ONE_AND_ZEROS",              Undefined),
    ("MBEDTLS_CIPHER_PADDING_ZEROS_AND_LEN",              Undefined),
    ("MBEDTLS_CIPHER_PADDING_ZEROS",                      Undefined),
    ...
    ("MBEDTLS_ECP_DP_SECP192R1_ENABLED",                  Undefined),
    ("MBEDTLS_ECP_DP_SECP224R1_ENABLED",                  Undefined),
    ("MBEDTLS_ECP_DP_SECP256R1_ENABLED",                  Undefined),
    ("MBEDTLS_ECP_DP_SECP384R1_ENABLED",                  Undefined),
    ("MBEDTLS_ECP_DP_SECP521R1_ENABLED",                  Undefined),
    ("MBEDTLS_ECP_DP_SECP192K1_ENABLED",                  Undefined),
    ("MBEDTLS_ECP_DP_SECP224K1_ENABLED",                  Undefined),
    ("MBEDTLS_ECP_DP_SECP256K1_ENABLED",                  Undefined),
    ("MBEDTLS_ECP_DP_BP256R1_ENABLED",                    Undefined),
    ("MBEDTLS_ECP_DP_BP384R1_ENABLED",                    Undefined),
    ("MBEDTLS_ECP_DP_BP512R1_ENABLED",                    Undefined),
    ("MBEDTLS_ECP_DP_CURVE25519_ENABLED",                 Undefined),
    ("MBEDTLS_ECP_DP_CURVE448_ENABLED",                   Undefined),
    ("MBEDTLS_ECP_NIST_OPTIM",                            Undefined),
    ("MBEDTLS_ECP_NO_INTERNAL_RNG",                       Undefined),
    ("MBEDTLS_ECP_RESTARTABLE",                           Undefined),
    ("MBEDTLS_ECDH_LEGACY_CONTEXT",                       Undefined),
    ("MBEDTLS_ECDSA_DETERMINISTIC",                       Undefined),
    ("MBEDTLS_KEY_EXCHANGE_PSK_ENABLED",                  Defined),
    ("MBEDTLS_KEY_EXCHANGE_DHE_PSK_ENABLED",              Undefined),
    ("MBEDTLS_KEY_EXCHANGE_ECDHE_PSK_ENABLED",            Undefined),
    ("MBEDTLS_KEY_EXCHANGE_RSA_PSK_ENABLED",              Undefined),
    ("MBEDTLS_KEY_EXCHANGE_RSA_ENABLED",                  Undefined),
    ("MBEDTLS_KEY_EXCHANGE_DHE_RSA_ENABLED",              Undefined),
    ("MBEDTLS_KEY_EXCHANGE_ECDHE_RSA_ENABLED",            Undefined),
    ("MBEDTLS_KEY_EXCHANGE_ECDHE_ECDSA_ENABLED",          Undefined),
    ("MBEDTLS_KEY_EXCHANGE_ECDH_ECDSA_ENABLED",           Undefined),
    ("MBEDTLS_KEY_EXCHANGE_ECDH_RSA_ENABLED",             Undefined),
    ("MBEDTLS_KEY_EXCHANGE_ECJPAKE_ENABLED",              Undefined),
    ("MBEDTLS_PK_PARSE_EC_EXTENDED",                      Undefined),
    ("MBEDTLS_ERROR_STRERROR_DUMMY",                      Undefined),
    ("MBEDTLS_GENPRIME",                                  Undefined),
    ("MBEDTLS_FS_IO",                                     Undefined),
    ("MBEDTLS_NO_DEFAULT_ENTROPY_SOURCES",                Undefined),
    ("MBEDTLS_NO_PLATFORM_ENTROPY",                       Defined), // only available on win/unix
    ...
    ("MBEDTLS_PK_RSA_ALT_SUPPORT",                        Undefined),
    ("MBEDTLS_PKCS1_V15",                                 Undefined),
    ("MBEDTLS_PKCS1_V21",                                 Undefined),
    ...
    ("MBEDTLS_SHA256_SMALLER",                            Defined), // smaller
    ("MBEDTLS_SHA512_SMALLER",                            Defined), // smaller
    ("MBEDTLS_SHA512_NO_SHA384",                          Undefined), // smaller but requires sha512
    ("MBEDTLS_SSL_ALL_ALERT_MESSAGES",                    Defined), // debugging (but potentially unsafer?)
    ("MBEDTLS_SSL_RECORD_CHECKING",                       Defined), // safer?
    ("MBEDTLS_SSL_DTLS_CONNECTION_ID",                    Undefined),
    ("MBEDTLS_SSL_ASYNC_PRIVATE",                         Undefined),
    ("MBEDTLS_SSL_CONTEXT_SERIALIZATION",                 Undefined),
    ("MBEDTLS_SSL_DEBUG_ALL",                             Undefined),
    ("MBEDTLS_SSL_ENCRYPT_THEN_MAC",                      Defined), // safer but should be unused (only for cbc)
    ("MBEDTLS_SSL_EXTENDED_MASTER_SECRET",                Defined), // safer
    ("MBEDTLS_SSL_FALLBACK_SCSV",                         Undefined), // not required for clients (should not fallback in the first place)
    ("MBEDTLS_SSL_KEEP_PEER_CERTIFICATE",                 Undefined),
    ("MBEDTLS_SSL_HW_RECORD_ACCEL",                       Undefined),
    ("MBEDTLS_SSL_CBC_RECORD_SPLITTING",                  Undefined),
    ("MBEDTLS_SSL_RENEGOTIATION",                         Undefined),
    ...
    ("MBEDTLS_SSL_DTLS_ANTI_REPLAY",                      Defined), // mostly
    ("MBEDTLS_SSL_DTLS_HELLO_VERIFY",                     Defined), // dtls-server
    ("MBEDTLS_SSL_DTLS_SRTP",                             Undefined), // side
    ("MBEDTLS_SSL_DTLS_CLIENT_PORT_REUSE",                Defined), // safety
    ("MBEDTLS_SSL_DTLS_BADMAC_LIMIT",                     Defined), // stuff
    ("MBEDTLS_SSL_SESSION_TICKETS",                       Undefined),
    ("MBEDTLS_SSL_EXPORT_KEYS",                           Undefined),
    ("MBEDTLS_SSL_SERVER_NAME_INDICATION",                Undefined),
    ("MBEDTLS_SSL_TRUNCATED_HMAC",                        Undefined),
    ...
    ("MBEDTLS_VERSION_FEATURES",                          Undefined),
    ...
    ("MBEDTLS_X509_CHECK_KEY_USAGE",                      Undefined),
    ("MBEDTLS_X509_CHECK_EXTENDED_KEY_USAGE",             Undefined),
    ("MBEDTLS_X509_RSASSA_PSS_SUPPORT",                   Undefined),
    ("MBEDTLS_ZLIB_SUPPORT",                              Undefined),
    ("MBEDTLS_AESNI_C",                                   Undefined),
    ("MBEDTLS_AES_C",                                     Defined),
    ("MBEDTLS_ARC4_C",                                    Undefined),
    ("MBEDTLS_ASN1_PARSE_C",                              Undefined),
    ("MBEDTLS_ASN1_WRITE_C",                              Undefined),
    ("MBEDTLS_BASE64_C",                                  Undefined),
    ("MBEDTLS_BIGNUM_C",                                  Undefined),
    ("MBEDTLS_BLOWFISH_C",                                Undefined),
    ("MBEDTLS_CAMELLIA_C",                                Undefined),
    ("MBEDTLS_ARIA_C",                                    Undefined),
    ("MBEDTLS_CCM_C",                                     Defined),
    ("MBEDTLS_CERTS_C",                                   Undefined),
    ("MBEDTLS_CHACHA20_C",                                Undefined),
    ("MBEDTLS_CHACHAPOLY_C",                              Undefined),
    ("MBEDTLS_CIPHER_C",                                  Defined),
    ("MBEDTLS_CMAC_C",                                    Undefined),
    ("MBEDTLS_CTR_DRBG_C",                                Defined),
    ("MBEDTLS_DEBUG_C",                                   Undefined),
    ("MBEDTLS_DES_C",                                     Undefined),
    ("MBEDTLS_DHM_C",                                     Undefined),
    ("MBEDTLS_ECDH_C",                                    Undefined),
    ("MBEDTLS_ECDSA_C",                                   Undefined),
    ("MBEDTLS_ECJPAKE_C",                                 Undefined),
    ("MBEDTLS_ECP_C",                                     Undefined),
    ("MBEDTLS_ENTROPY_C",                                 Undefined),
    ("MBEDTLS_ERROR_C",                                   Undefined),
    ("MBEDTLS_GCM_C",                                     Undefined),
    ("MBEDTLS_HAVEGE_C",                                  Undefined),
    ("MBEDTLS_HKDF_C",                                    Undefined), // required???
    ("MBEDTLS_HMAC_DRBG_C",                               Undefined), // instead of ctr_drbg_c?
    ("MBEDTLS_NIST_KW_C",                                 Undefined),
    ("MBEDTLS_MD_C",                                      Defined),
    ("MBEDTLS_MD2_C",                                     Undefined),
    ("MBEDTLS_MD4_C",                                     Undefined),
    ("MBEDTLS_MD5_C",                                     Undefined),
    ("MBEDTLS_MEMORY_BUFFER_ALLOC_C",                     Undefined), // heapless!
    ("MBEDTLS_NET_C",                                     Undefined),
    ("MBEDTLS_OID_C",                                     Undefined),
    ("MBEDTLS_PADLOCK_C",                                 Undefined),
    ("MBEDTLS_PEM_PARSE_C",                               Undefined),
    ("MBEDTLS_PEM_WRITE_C",                               Undefined),
    ("MBEDTLS_PK_C",                                      Undefined),
    ("MBEDTLS_PK_PARSE_C",                                Undefined),
    ("MBEDTLS_PK_WRITE_C",                                Undefined),
    ("MBEDTLS_PKCS5_C",                                   Undefined), // PBKDF2?
    ...
    ("MBEDTLS_RSA_C",                                     Undefined),
    ("MBEDTLS_SHA1_C",                                    Undefined),
    ("MBEDTLS_SHA256_C",                                  Defined),
    ("MBEDTLS_SHA512_C",                                  Undefined),
    ("MBEDTLS_SSL_CACHE_C",                               Defined),
    ("MBEDTLS_SSL_COOKIE_C",                              Defined),
    ("MBEDTLS_SSL_TICKET_C",                              Defined),
    ("MBEDTLS_SSL_CLI_C",                                 Defined),
    ("MBEDTLS_SSL_SRV_C",                                 Undefined),
    ("MBEDTLS_SSL_TLS_C",                                 Defined),
    ("MBEDTLS_THREADING_C",                               Undefined),
    ("MBEDTLS_TIMING_C",                                  Undefined),
    ("MBEDTLS_VERSION_C",                                 Defined),
    ("MBEDTLS_X509_USE_C",                                Undefined),
    ("MBEDTLS_X509_CRT_PARSE_C",                          Undefined),
    ("MBEDTLS_X509_CRL_PARSE_C",                          Undefined),
    ("MBEDTLS_X509_CSR_PARSE_C",                          Undefined),
    ("MBEDTLS_X509_CREATE_C",                             Undefined),
    ("MBEDTLS_X509_CRT_WRITE_C",                          Undefined),
    ("MBEDTLS_X509_CSR_WRITE_C",                          Undefined),
    ("MBEDTLS_XTEA_C",                                    Undefined),
    ...
    ("MBEDTLS_TLS_DEFAULT_ALLOW_SHA1_IN_KEY_EXCHANGE",    Undefined),
